...
class IncomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create income" do
    assert_difference('Income.count') do
      post incomes_url, params: { income: { date: @income.date, description: @income.description, price: @income.price } }
    end
  ...
  test "should update income" do
    patch income_url(@income), params: { income: { date: @income.date, description: @income.description, price: @income.price } }
