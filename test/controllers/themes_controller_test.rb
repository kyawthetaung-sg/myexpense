...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { color: @theme.color, deleted_at: @theme.deleted_at, deleted_by: @theme.deleted_by, name: @theme.name } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { color: @theme.color, deleted_at: @theme.deleted_at, deleted_by: @theme.deleted_by, name: @theme.name } }
